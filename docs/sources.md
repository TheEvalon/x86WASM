...
- ATA / ATAPI specifications (IDENTIFY DEVICE `0xEC`, PACKET `0xA0`, IDENTIFY PACKET DEVICE `0xA1`, READ SECTORS `0x20`, WRITE SECTORS `0x30`, task-file / status bits, error ABRT, LBA28 PIO, device-control nIEN / INTRQ; PACKET is ATAPI-only — ATA disks abort with ERR+ABRT and do not enter the 12-byte packet DRQ phase)
