...
- [ ] Interrupts (hardware / PIC-driven) â€” stub: `CpuState::pending_irq` / `request_interrupt` + REP iteration poll when IF=1; no 8259 yet
- [ ] 32-bit paging
- [ ] 8259 PIC
- [ ] 8254 PIT
- [ ] RTC
