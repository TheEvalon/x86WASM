...
Status (2026-08-02, branch `feat/real-mode-int-iret`): **in progress** — real-mode foundation **audit tranche** landed (RM-D/E/F/G, REP, word strings, opsize32, #UD IVT, INS/OUTS, BCD, INTO/BOUND); **not SeaBIOS-ready**. M2 exit criteria are not met.
...
- [x] Complete real-mode foundation (**audit gaps landed**: RM-D/E/F/G, REP/REPE/REPNE, word/dword strings, 0x66 opsize-32 tranche, #UD IVT, INS/OUTS, BCD, INTO/BOUND, ENTER nesting>0) — **not SeaBIOS-ready**; remaining: full 0x66 coverage (incl. ENTERD), #GP/#SS memory-fault classification, interruptible REP, decode-miss→#UD, unreal segment limits, MOVSQ/STOSQ/… qword strings, 0F AF IMUL, address-size 0x67 completeness, etc.
- [ ] Protected mode
