...
- [ ] Complete real-mode foundation (remaining opcodes under 0x66, full unreal-mode segment limits/paging, #GP/#SS memory-fault classification, decode-unknown→#UD policy, word/dword string ops, interruptible REP, ENTER nesting>0, 0F AF IMUL, address-size 0x67 completeness, etc.)
- [ ] Protected mode
