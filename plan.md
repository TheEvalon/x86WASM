...
- [x] Complete real-mode foundation (**audit gaps landed**: RM-D/E/F/G, REP/REPE/REPNE, word/dword strings, 0x66 opsize-32 tranche, #UD IVT, INS/OUTS, BCD, INTO/BOUND) — **not SeaBIOS-ready**; remaining: full 0x66 coverage, #GP/#SS memory-fault classification, interruptible REP, decode-miss→#UD, unreal segment limits, MOVSQ/STOSQ/… qword strings, ENTER nesting>0, 0F AF IMUL, address-size 0x67 completeness, etc.
- [ ] Protected mode
