...
Status (2026-08-10, round-13 cpu-vm86 lane `slice/r13-cpu-vm86` on base `f579e8c`): **in progress -- R13 cpu-vm86 lane.** VME `CLI`/`STI` → `VIF` when `CR4.VME=1` and `IOPL<3` (VIP∧VIF/IF `#GP`); still **no** `CPUID.VME`. See `docs/cpu-r13-*.md`.
