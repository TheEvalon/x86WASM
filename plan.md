...
- [ ] Hard-disk boot — **partial:** `Machine::attach_ide_image` / `with_ide` + `Machine::load_mbr_to_7c00` copies primary IDE LBA0 (prefer) or floppy CHS `(0,0,1)` into phys `0x7C00`, requires `0x55AA` signature, sets `CS:IP = 0000:7C00` for synthetic MBR handoff tests; **not** SeaBIOS INT 13h / partition walk / FreeDOS disk boot / CD-ROM
- [ ] CD-ROM boot
