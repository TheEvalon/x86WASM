...
- [ ] Protected mode — **partial:** real-mode `LGDT`/`SGDT` (`0F 01 /2`,`/0`) load/store `CpuState::gdtr` (m16&32; opsize-16 → 24-bit base, `0x66` → 32-bit; mod=11 `#UD`); **not** PE/CR0, far jumps to PM, descriptors, privilege
