...
Status (2026-08-10, round-10 timers-apic lane `slice/r10-timers-apic`): **in progress on this branch** — LAPIC TMR (Trigger Mode) + TPR/PPR priority stub; HPET?IOAPIC Fixed wire (`advance_hpet_ioapic`); IOAPIC non-Fixed delivery-mode honesty. See `docs/lapic-r10-tmr.md`, `docs/lapic-r10-tpr-ppr.md`, `docs/hpet-r10-ioapic-wire.md`, `docs/ioapic-r10-delivery-mode.md`. Not yet merged with other R10 lanes.
