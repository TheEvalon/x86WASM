...
- [x] Complete real-mode foundation (**audit gaps landed**: RM-D/E/F/G, REP/REPE/REPNE, word/dword strings, 0x66 opsize-32 tranche, #UD IVT, INS/OUTS, BCD, INTO/BOUND, ENTER nesting>0, 0F AF IMUL, decode-miss architectural #UD + stack/ModRM #GP/#SS classify) — **not SeaBIOS-ready**; remaining: full 0x66 coverage (incl. ENTERD), interruptible REP, string/moffs/fetch MemoryFault classify, unreal segment limits, MOVSQ/STOSQ/… qword strings, address-size 0x67 completeness, etc.
- [ ] Protected mode
