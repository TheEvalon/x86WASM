...
use devices::{
    ...
    VGA_GC_MISC_MEMORY_MAP_SHIFT, VGA_GC_MODE, VGA_GC_MODE_DEFAULT,
    VGA_GC_MODE_HOST_ODD_EVEN_READ as GC_MODE_HOST_ODD_EVEN_READ, VGA_GC_MODE_READ,
...
// Graphics Mode bit 4 — Host Odd/Even Memory Read Addressing Enable — is set
// in the mode-03h reset default.
