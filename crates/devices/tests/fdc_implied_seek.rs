...
use devices::{
    Fdc82077, PortDevice, FDC_1440_CYLINDERS, FDC_1440_IMAGE_SIZE, FDC_CMD_CONFIGURE,
    FDC_CMD_DUMPREG, FDC_CMD_FORMAT_TRACK_MFM, FDC_CMD_MFM, FDC_CMD_READ_DATA, FDC_CMD_READ_ID_MFM,
    FDC_CMD_READ_TRACK_MFM, FDC_CMD_SENSE_DRIVE_STATUS, FDC_CMD_VERIFY, FDC_CMD_WRITE_DATA,
    FDC_DOR, FDC_DOR_DMA_IRQ, FDC_DOR_RESET_N, FDC_FIFO, FDC_SECTOR_N, FDC_ST0_IC_ABNORMAL,
    FDC_ST0_IC_NORMAL, FDC_ST1_MA, FDC_ST1_ND, FDC_ST3_TRACK0,
};

/// DUMPREG. Spec: Intel 82077AA §5.2.10 / Table 5-1.
const CMD_DUMPREG: u32 = FDC_CMD_DUMPREG as u32;
/// READ TRACK with MFM. Spec: Intel 82077AA §5.1.3 / Table 5-1 (`MFM|00010`).
const CMD_READ_TRACK_MFM: u32 = FDC_CMD_READ_TRACK_MFM as u32;
/// VERIFY with MFM. Spec: Intel 82077AA Table 5-1 (`MFM|10110`).
const CMD_VERIFY_MFM: u32 = (FDC_CMD_MFM | FDC_CMD_VERIFY) as u32;
/// FORMAT TRACK with MFM. Spec: Intel 82077AA §5.1.7 / Table 5-1 (`MFM|01101`).
const CMD_FORMAT_TRACK_MFM: u32 = FDC_CMD_FORMAT_TRACK_MFM as u32;
