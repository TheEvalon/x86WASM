...
//! - Status error *signaling* (host / ISA / IDE / USB never latch RW1C bits from real aborts yet)
//! - Capability list walk (CapList hardwired 0 on host / ISA / IDE / USB)
//! - ACPI Status stubs
...
impl PciConfig {
    ...
    fn write_data(&mut self, size: u8, port: u16, value: u32) {
        ...
        let old_status = if is_host_bridge || is_piix_isa || is_piix_ide || is_piix_usb {
