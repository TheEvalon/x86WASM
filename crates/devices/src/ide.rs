...
//!   (`0x3F`), DATA SET MANAGEMENT (`0x06`), TRUSTED RECEIVE (`0x5C`), task-file
...
//! - TRUSTED RECEIVE / TRUSTED SEND Security Protocol PIO (ABRT-only stub for
//!   `0x5C`; `0x5E` remains catch-all ABRT)
