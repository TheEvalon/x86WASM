...
pub use fdc::{
    Fdc82077, FDC_CMD_RECALIBRATE, FDC_CMD_SEEK, FDC_CMD_SENSE_INT, FDC_CMD_SPECIFY, FDC_DIR_CCR,
    FDC_DOR, FDC_DOR_DMA_IRQ, FDC_DOR_RESET_N, FDC_FIFO, FDC_MSR, FDC_MSR_DIO, FDC_MSR_RQM,
    FDC_SRA, FDC_SRB, FDC_ST0_IC_READY_CHANGE, FDC_ST0_SEEK_END, FDC_TDR,
};
pub use i8042::{
