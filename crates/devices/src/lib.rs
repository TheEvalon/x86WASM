...
//! 82077AA FDC port stub (0x3F0–0x3F5/0x3F7; Sense Interrupt 0x08; IRQ6; no media).
...
pub use fdc::{
    Fdc82077, FDC_CMD_SENSE_INT, FDC_CMD_SPECIFY, FDC_DIR_CCR, FDC_DOR, FDC_DOR_DMA_IRQ,
    FDC_DOR_RESET_N, FDC_FIFO, FDC_MSR, FDC_MSR_DIO, FDC_MSR_RQM, FDC_SRA, FDC_SRB, FDC_TDR,
};
pub use i8042::{
