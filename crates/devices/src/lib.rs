...
pub use vga::{
    ...
    VGA_DEFAULT_CHAR, VGA_MISC_OUTPUT_DEFAULT, VGA_MISC_OUTPUT_READ, VGA_MISC_OUTPUT_WRITE,
    VGA_SEQ_DATA, VGA_SEQ_DEFAULTS, VGA_SEQ_INDEX, VGA_SEQ_REG_COUNT, VGA_TEXT_BASE, VGA_TEXT_COLS,
