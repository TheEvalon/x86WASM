...
//! CMOS/RTC IRQ8; 8042/PS2 on MachineBus 0x60/0x64 (IRQ1 + output-port A20).
...
pub use i8042::{
    CFG_INT1, CFG_INT12, CMD_DISABLE_KBD, CMD_ENABLE_KBD, CMD_READ_CONFIG, CMD_READ_OUTPUT_PORT,
    CMD_SELF_TEST, CMD_WRITE_CONFIG, CMD_WRITE_OUTPUT_PORT, I8042, I8042_DATA, I8042_STATUS_CMD,
    OUTPUT_PORT_A20, SELF_TEST_OK, STATUS_CMD, STATUS_IBF, STATUS_OBF, STATUS_SYS,
};
