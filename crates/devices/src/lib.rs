...
pub use fdc::{
    ...
    FDC_CMD_SPECIFY, FDC_DIR_CCR, FDC_DOR, FDC_DOR_DMA_IRQ, FDC_DOR_RESET_N, FDC_FIFO, FDC_MSR,
    FDC_MSR_DIO, FDC_MSR_RQM, FDC_SRA, FDC_SRB, FDC_ST0_IC_READY_CHANGE, FDC_ST0_SEEK_END,
    FDC_ST3_HEAD, FDC_ST3_RESERVED_BIT3, FDC_ST3_RESERVED_BIT5, FDC_ST3_TRACK0, FDC_ST3_UNIT_MASK,
    FDC_ST3_WRITE_PROTECT, FDC_TDR,
};
pub use i8042::{
