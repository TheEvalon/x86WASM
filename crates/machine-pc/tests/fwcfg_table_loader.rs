...
//!
//! Spec / policy: ADR-0005, `docs/fwcfg-r4-selectors.md` — the QEMU/SeaBIOS
//! table-loader command stream installs ACPI tables; this machine has none, so
//! `Machine::sync_firmware_configuration` keeps the name absent.
