...
pub use int10::{
    ...
    setup_int10_vbe_controller_info, setup_int10_write_char, setup_int10_write_char_attr,
    BDA_ACTIVE_PAGE, BDA_CRT_CTRL_BASE, BDA_CURSOR_PAGE0, BDA_CURSOR_TYPE, BDA_VIDEO_COLS,
    BDA_VIDEO_MODE, BDA_VIDEO_PAGE_SIZE, BDA_VIDEO_PAGE_START, BDA_VIDEO_ROWS_MINUS_1,
    INT10_AH_GET_CURSOR, INT10_AH_GET_MODE, INT10_AH_SET_CURSOR, INT10_AH_SET_CURSOR_TYPE,
    INT10_AH_SET_MODE, INT10_AH_TELETYPE, INT10_AH_VBE, INT10_AH_WRITE_CHAR,
    INT10_AH_WRITE_CHAR_ATTR, INT10_AL_VBE_CONTROLLER_INFO, INT10_CRT_BASE_COLOR,
    ...
    INT10_VECTOR, INT10_WRITE_CHAR_MAX_COUNT,
};
pub use int13::{
