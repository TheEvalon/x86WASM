...
pub use int10::{
    ...
    setup_int10_scroll_window, setup_int10_set_active_page, setup_int10_set_cursor,
    setup_int10_set_cursor_type, setup_int10_set_mode, setup_int10_teletype,
    setup_int10_vbe_controller_info, setup_int10_vbe_get_mode, setup_int10_vbe_mode_info,
    setup_int10_vbe_set_mode, setup_int10_write_char, setup_int10_write_char_attr,
    setup_int10_write_string, BDA_ACTIVE_PAGE, BDA_CRT_CTRL_BASE, BDA_CURSOR_PAGE0,
    BDA_CURSOR_TYPE, BDA_VIDEO_COLS, BDA_VIDEO_MODE, BDA_VIDEO_PAGE_SIZE, BDA_VIDEO_PAGE_START,
    BDA_VIDEO_ROWS_MINUS_1, INT10_AH_GET_CURSOR, INT10_AH_GET_MODE, INT10_AH_READ_CHAR_ATTR,
    INT10_AH_SCROLL_DOWN, INT10_AH_SCROLL_UP, INT10_AH_SET_ACTIVE_PAGE, INT10_AH_SET_CURSOR,
    ...
    INT10_AL_VBE_CONTROLLER_INFO, INT10_AL_VBE_GET_MODE, INT10_AL_VBE_MODE_INFO, INT10_AL_VBE_PMI,
    INT10_AL_VBE_SET_MODE, INT10_CRT_BASE_COLOR, INT10_MODE03_CURSOR_END,
    INT10_MODE03_CURSOR_START, INT10_MODE03_MAX_PAGE, INT10_MODE03_PAGE_SIZE,
...
pub use int13::{
    ...
    INT13_CD_SECTOR_SIZE, INT13_CD_SPEC_PACKET_SIZE, INT13_DAP_SIZE_MIN, INT13_DISK_TYPE_FLOPPY,
    INT13_DISK_TYPE_FLOPPY_CHANGE_LINE, INT13_DISK_TYPE_HARD, INT13_DISK_TYPE_NONE,
    INT13_DRIVE_CD0, INT13_DRIVE_CD_ALL, INT13_DRIVE_FD0, INT13_DRIVE_HD0,
    INT13_EDD_INFO_GEOMETRY_VALID, INT13_EDD_PARAMS_SIZE_MIN, INT13_EXT_CX_EDD,
    INT13_EXT_CX_LOCKING, INT13_EXT_CX_PACKET, INT13_EXT_CX_SUPPORTED, INT13_EXT_MAGIC_IN,
...
mod tests {
    ...
    fn machine_bus_piix_usb_uhci_bar0_port_decode() {
        ...
        let mut m = Machine::new(64 * 1024);
        {
            ...
            assert_eq!(bus.port_in_u16(0xD002).unwrap(), 0x0000); // RS set → not halted
            assert_eq!(bus.port_in_u16(0xD004).unwrap(), 0x000F);
