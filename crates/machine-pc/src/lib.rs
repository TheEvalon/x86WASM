...
pub use int10::{
    ...
    setup_int10_write_char_attr, BDA_ACTIVE_PAGE, BDA_CURSOR_PAGE0, BDA_CURSOR_TYPE, BDA_VIDEO_COLS,
    BDA_VIDEO_MODE, BDA_VIDEO_PAGE_SIZE, BDA_VIDEO_PAGE_START, INT10_AH_GET_CURSOR,
    INT10_AH_GET_MODE, INT10_AH_SET_CURSOR, INT10_AH_SET_CURSOR_TYPE, INT10_AH_SET_MODE,
    INT10_AH_TELETYPE, INT10_AH_WRITE_CHAR, INT10_AH_WRITE_CHAR_ATTR, INT10_MODE03_CURSOR_END,
    INT10_MODE03_CURSOR_START, INT10_MODE03_PAGE_SIZE, INT10_MODE13_PAGE_SIZE, INT10_MODE_03H_TEXT,
    INT10_MODE_13H_GRAPHICS, INT10_VECTOR, INT10_WRITE_CHAR_MAX_COUNT,
};
pub use int13::{
