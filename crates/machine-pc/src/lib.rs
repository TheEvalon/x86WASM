//! Classic PC machine: CPU lab, serial HELLO ROM, and M2 PIC/PIT/CMOS/8042/VGA wiring.
...
use devices::{
    CmosRtc, DebugConsole, DualPic, Pit8254, PortDevice, Serial16550, VgaText, CMOS_DATA,
