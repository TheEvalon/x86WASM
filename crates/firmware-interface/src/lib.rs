...
pub use el_torito::{
    ...
    EL_TORITO_DEFAULT_LOAD_PHYS, EL_TORITO_DEFAULT_LOAD_SEGMENT, EL_TORITO_KEY_55,
    EL_TORITO_KEY_AA, EL_TORITO_MEDIA_NO_EMUL, EL_TORITO_PLATFORM_X86, EL_TORITO_SECTOR_BYTES,
